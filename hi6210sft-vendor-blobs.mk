...
# Wifi
PRODUCT_COPY_FILES += \
        $(LOCAL_PATH)/etc/wifi/hostapd_hisi.conf:system/etc/wifi/ \
        $(LOCAL_PATH)/etc/wifi/p2p_supplicant_overlay.conf:system/etc/wifi/ \
        $(LOCAL_PATH)/etc/wifi/wpa_supplicant.conf:system/etc/wifi/ \
        $(LOCAL_PATH)/etc/wifi/wpa_supplicant_hisi.conf:system/etc/wifi/ \
        $(LOCAL_PATH)/etc/wifi/wpa_supplicant_overlay.conf:system/etc/wifi/ \
